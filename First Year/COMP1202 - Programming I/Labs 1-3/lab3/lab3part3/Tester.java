...
public class Tester {
    ...
    */
    ...
    public static void testPart3() {
        ...
        Door newDoor = new Door(); // Create new door.
        newDoor.setRoomName("Research Labs");
        CardLock newCardLock = new CardLock(); // Create new card lock.
        newDoor.attachLock(newCardLock); // Attach the CardLock to the Door.
        SmartCard newStudentSmartCard = new SmartCard("Dan Undergrad"); // Create new student SmartCard.
        newCardLock.swipeCard(newStudentSmartCard); // Swipe the student SmartCard on the CardLock.
        newDoor.openDoor(); // Try to open the Door.
        SmartCard newStaffSmartCard = new SmartCard("Dr. Anne Lecturer"); // Create a new staff SmartCard.
        newStaffSmartCard.setStaff(true); // Set the SmartCard to be staff level.
        newCardLock.swipeCard(newStaffSmartCard); // Swipe the staff SmartCard on the CardLock.
        newDoor.openDoor(); // Try to open Door again.
