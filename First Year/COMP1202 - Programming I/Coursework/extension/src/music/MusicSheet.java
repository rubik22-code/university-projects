...
public class MusicSheet implements Composition {
  ...
  // Fetching value from EcsBandAid to be used in the Conductor class.
  int[] noteLengthArray;
  // Creating one method for fetching and another for returning the value, hence why this exists.
  static int[] noteLengthArrayCopy;
  ...
  /**
   * Created an empty constructor to initialise the object in Conductor.
   * Then I can use the getNoteLengthArray() method to retrieve my array of lengths.
   */
  ...
  /*
  Extension: Stores value from EcsBandAid to use in Conductor.
   */
  public void storeNoteLengthArray(int[] noteLengthArrayParam) {
    noteLengthArray = noteLengthArrayParam;
    // Creating a copy to use in another method.
    noteLengthArrayCopy = noteLengthArray;
  }

  /*
  Extension: Uses value from Conductor.
   */

  public int[] getNoteLengthArray() {
    return noteLengthArrayCopy;
  }
}
