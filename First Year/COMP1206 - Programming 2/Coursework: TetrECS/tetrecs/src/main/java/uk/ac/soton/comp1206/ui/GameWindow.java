...
public class GameWindow {
    ...
    public void startScores(Game game, boolean flag) {
        loadScene(new ScoresScene(this, game, flag));
    }

    public void startScoresMulti(Game game, boolean flag, String otherPlayerName, int otherPlayerScore, String myPlayerName) {
        loadScene(new ScoresScene(this, game, flag, otherPlayerName, otherPlayerScore, myPlayerName));
    }
    ...
    public void startMultiplayerChallenge() { loadScene(new MultiplayerScene(this)); }
